...
try {
    ...
    Write-Host ""
    Write-Host "🎉 Azure Cognitive Search components created successfully!" -ForegroundColor Green
    Write-Host ""
    Write-Host "Created components:" -ForegroundColor Cyan
    Write-Host "- Data Source: $SearchDataSourceName" -ForegroundColor White
    Write-Host "- Search Index: $SearchIndexName" -ForegroundColor White
    Write-Host "- Skillset: $SkillsetName" -ForegroundColor White
    Write-Host "- Indexer: $SearchIndexerName" -ForegroundColor White
    Write-Host ""
    Write-Host "Next steps:" -ForegroundColor Yellow
    Write-Host "1. Upload documents to the storage container: $StorageContainerName"
    Write-Host "2. Run the indexer to process documents"
    Write-Host "3. Test search functionality in CoPPA"
}
catch {
