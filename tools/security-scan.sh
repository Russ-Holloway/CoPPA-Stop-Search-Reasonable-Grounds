...
# =============================================================================
# CoPPA Security Scanner - Comprehensive Security Assessment Tool
# =============================================================================
# This script performs comprehensive security scanning for the CoPPA application,
...
CoPPA Security Scanner - Comprehensive security assessment for police data applications
...
print_header() {
    echo -e "${BLUE}╔════════════════════════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${BLUE}║                        CoPPA Security Scanner v2.0                            ║${NC}"
...
<head>
    ...
    <title>CoPPA Security Assessment Report</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🛡️ CoPPA Security Assessment Report</h1>
...
EOF
    ...
    cat >> "$html_file" << EOF
        ...
        <div class="footer">
            <p>Generated by CoPPA Security Scanner v2.0 | Police Data Security Compliant</p>
        </div>
    </div>
</body>
</html>
